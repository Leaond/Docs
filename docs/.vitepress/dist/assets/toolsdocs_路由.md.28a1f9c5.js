import{_ as s,o as e,c as a,Q as n}from"./chunks/framework.37d083f2.js";const h=JSON.parse('{"title":"路由","description":"","frontmatter":{},"headers":[],"relativePath":"toolsdocs/路由.md","filePath":"toolsdocs/路由.md"}'),l={name:"toolsdocs/路由.md"},p=n(`<h1 id="路由" tabindex="-1">路由 <a class="header-anchor" href="#路由" aria-label="Permalink to &quot;路由&quot;">​</a></h1><pre><code>VitePress使用的是基于文件的路由，所以生成的HTML页面是从MarkDown文件的目录结构映射而来的。
